        ...
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            <div className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center transition-colors duration-300 ${
              ...
              <div className={`w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-sm transition-colors duration-300 ${
                highlightHeader ? "bg-black" : "bg-white"
              }`}></div>
            </div>
            <span className={`text-lg sm:text-xl font-semibold font-sans transition-colors duration-300 ${
          ...
          <div className="flex items-center gap-3 sm:gap-6">
            ...
            <Link
              href="/login"
              className={`text-sm sm:text-base font-medium bg-transparent rounded-full px-3 sm:px-6 py-2 transition-all duration-200 ease-out font-sans ${
                highlightHeader
